                    ...
                    <tbody>
                        <template v-for="(value, index) in list_don_hang" :key="index">
                            <tr class="align-middle">
                                ...
                                <td class="align-middle text-center">
                                    <a target="_blank" :href="'/admin/in-ve/' + value.ma_don_hang" class="btn btn-secondary btn-sm pe-1 me-2">
...
export default {
    ...
    methods: {
        ...
        getDonHang() {
            axios.get('http://localhost:8000/api/admin/don-hang/get-data')
                .then((res) => {
                    this.list_don_hang = res.data.data;
                });
        },
        getChiTietDichVu(id) {
            axios.get('http://localhost:8000/api/admin/chi-tiet-dich-vu/' + id)
                .then((res) => {
        ...
        xoaDonHang() {
            axios.post('http://localhost:8000/api/admin/don-hang/delete', this.don_huy)
                .then((res) => {
                    if (res.data.status) {
